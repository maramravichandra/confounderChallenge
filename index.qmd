...
ggplot(patients_randomized_df, aes(x = patient, y = post_surgical_score, color = doctor_name, shape = doctor_name)) +
  ...
  # Mean lines
  geom_hline(yintercept = mean_dreamy_rand, color = color_dreamy, linetype = "dashed", linewidth = 1) +
  geom_hline(yintercept = mean_duck_rand, color = color_duck, linetype = "dashed", linewidth = 1) +
